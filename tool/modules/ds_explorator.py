...
class RandomExplorer:
    ...
    def get_genetic(self,x):
        ...
        for loop in self.exploration_file.optimization_points_loops():
            ...
            pragma_list = loop_pragma_generator(True,x[counter],True,x[counter+1])
            counter+=2
        ...
        for array in list(self.exploration_file.optimization_points_arrays()):
            ...
            rand_dim = randint(1,1)
            mode = 'cyclic'
            if(x[counter+1] == 0): mode = 'block'
                
            pragma_list = array_pragma_generator(array,True, mode, 2 ** x[counter],1)
            counter+=2
